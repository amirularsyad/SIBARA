            ...
            <div class="row mt-3">
                <div class="col-6 p-0">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="sn" value="<?= htmlspecialchars(isset($data['sn']) ? $data['sn'] : '') ?>" required>
                    </div>
                </div>
                ...
                <div class="col-6 p-0">
                    <div class="input-group ms-2">
                        ...
                        <input type="text" class="form-control" name="merk" value="<?= htmlspecialchars(isset($data['merek']) ? $data['merek'] : '') ?>" required>
                    </div>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-6 p-0">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="prosesor" value="<?= htmlspecialchars(isset($data['prosesor']) ? $data['prosesor'] : '') ?>" required>
                    </div>
                </div>
                ...
                <div class="col-6 p-0">
                    <div class="input-group ms-2">
                        ...
                        <input type="text" class="form-control" name="penyimpanan" value="<?= htmlspecialchars(isset($data['penyimpanan']) ? $data['penyimpanan'] : '') ?>" required>
                    </div>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-6 p-0">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="monitor" value="<?= htmlspecialchars(isset($data['monitor']) ? $data['monitor'] : '') ?>" required>
                    </div>
                </div>
                ...
                <div class="col-6 p-0">
                    <div class="input-group ms-2">
                        ...
                        <input type="text" class="form-control" name="baterai" value="<?= htmlspecialchars(isset($data['baterai']) ? $data['baterai'] : '') ?>" required>
                    </div>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-6 p-0">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="vga" value="<?= htmlspecialchars(isset($data['vga']) ? $data['vga'] : '') ?>" required>
                    </div>
                </div>
                ...
                <div class="col-6 p-0">
                    <div class="input-group ms-2">
                        ...
                        <input type="text" class="form-control" name="ram" value="<?= htmlspecialchars(isset($data['ram']) ? $data['ram'] : '') ?>" required>
                    </div>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-5 p-0">
                    <div class="input-group">
                        ...
                        <input type="date" class="form-control" name="tanggal-pembelian" id="tanggal-pembelian" max="<?= date('Y-m-d') ?>" value="<?= htmlspecialchars(isset($data['tanggal_pembelian']) ? $data['tanggal_pembelian'] : '') ?>" required>
                    </div>
                </div>
            </div>
            ...
            <div class="input-group" style="width: 35%;">
                ...
                <select name="saksi" id="saksi" class="form-select" required>
                    ...
                    foreach ($saksi_list as $saksi) {
                        $selected = ($data['saksi'] == $saksi) ? "selected" : "";
                        echo "<option value='" . htmlspecialchars($saksi) . "' $selected>" . htmlspecialchars($saksi) . "</option>";
                    }
                    ?>
                </select>
            </div>
