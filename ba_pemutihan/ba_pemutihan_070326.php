...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary overflow-x-hidden">
    ...
    <div class="app-wrapper">
        ...
        if (!empty($filter_pt) && $filter_pt !== 'all') {
            ...
            if (!($_SESSION['hak_akses'] === 'Admin' && $is_user_ho)) {
                ...
                if (count($pt_list) > 0) {
                    ...
                    $where_clauses[] = "bapmthn.pt IN ($placeholders)";
        ...
        $where_clauses[] = "bapmthn.dihapus = 0";
        ...
        // Query utama
        $query =    "SELECT bapmthn.*, cb.nama AS kategori_nama
                FROM berita_acara_pemutihan bapmthn
                $where_sql
                ORDER BY bapmthn.tanggal DESC, bapmthn.nomor_ba DESC";
    ...
    <script> //Form Input
        ...
        userSelect.addEventListener('change', function() {
            ...
            if (userData.jabatan === "Dept. Head" || userData.jabatan === "AVP Head" || userData.jabatan === "Direktur" || userData.jabatan === "BOD" || userData.jabatan === "Div. Head") {
        ...
        `;
            ...
            function wireEditFormSelects(data, karyawan, atasan) {
                ...
                if (ptSelect.value === 'PT.MSAL (HO)') {
                    ...
                    if (userData) {
                        if (userData.jabatan && userData.jabatan.trim() === "Dept. Head" || userData.jabatan && userData.jabatan.trim() === "AVP Head" || userData.jabatan && userData.jabatan.trim() === "Direktur" || userData.jabatan && userData.jabatan.trim() === "BOD" || userData.jabatan && userData.jabatan.trim() === "Div. Head") {
                ...
                userSelect.addEventListener('change', function() {
                    ...
                    console.log("Bukan Dept. Head, AVP, Direktur, BOD atau Div. Head, load atasan by dept:", userData.departemen);
