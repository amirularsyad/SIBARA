...
<head>
  ...
  <title>Detail BA Pengembalian</title>
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary overflow-x-hidden">
    ...
    <aside class="app-sidebar shadow" data-bs-theme="dark"> <!-- Sidebar -->
        ...
        <nav class="mt-2">
            ...
            <!-- <?php if ($_SESSION['hak_akses'] === 'Admin'): ?>
            <li class="nav-item">
                <a href="tatus.php" class="nav-link">
    ...
    <main class="app-main">
        ...
        <div class=" d-flex align-items-center justify-content-center position-relative">
            <div class=" position-absolute" style="left: 0;">
                <a class='btn btn-primary btn-sm' href='surat_output_pengembalian.php?id=<?= $data['id'] ?>' target='_blank'><i class="bi bi-file-earmark-text-fill"></i></a>
                <?php
                    $sessionUser = isset($_SESSION['nama']) ? $_SESSION['nama'] : '';

                    $namaAprv1 = isset($data['nama_pengembali']) ? trim($data['nama_pengembali']) : '';
                    $namaAprv2 = isset($data['nama_penerima']) ? trim($data['nama_penerima']) : '';
                    $namaAprv3 = '';
                    if (isset($data['diketahui']) && $data['diketahui'] !== '') {
                        $parts = explode(' - ', $data['diketahui']);
                        $namaAprv3 = trim($parts[0]); // ambil bagian pertama
                    }
