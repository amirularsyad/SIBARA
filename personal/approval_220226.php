...
if (!empty($filterPT)) {
    ...
    // $filtersMutasi[]      = "bam.pt_asal = '" . $koneksi->real_escape_string($filterPT) . "'";
    $pt = $koneksi->real_escape_string($filterPT); $filtersMutasi[] = "(bam.pt_asal = '$pt' OR bam.pt_tujuan = '$pt')";
    $filtersSTAsset[]      = "basta.pt = '" . $koneksi->real_escape_string($filterPT) . "'";
}
...
LEFT JOIN $asalTable k2 ON bam.pengirim1 = k2.nama
...
function statusBadge($approval, $row, $colApproval, $colAutograph, $nama, $peran, $jenisBA, $pictAutograph, $ptOtoritas)
{
    ...
    if ($approval == 1) {
        ...
        if($jenisBA === 'kerusakan'){
            if (isset($ptOtoritas) && isset($_SESSION['pt']) && is_array($_SESSION['pt']) && in_array($ptOtoritas, $_SESSION['pt'], true)
            ) {
            return "
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary overflow-x-hidden">
                ...
                <form method="get" class="mb-3 d-flex gap-2 flex-wrap align-items-end">
                    ...
                    <div class="custom-form-select-pt">
                        ...
                        <select name="pt" class="form-select" onchange="this.form.submit()">
                            ...
                            <?php
                            // Daftar PT yang memang valid di sistem
                            // $allPT = [
                            //     'PT.MSAL (HO)',
                            //     'PT.MSAL (SITE)',
                            //     'PT.MAPA',
                            ...
                            // // Ambil semua PT milik user (array)
                            // $userPT = isset($_SESSION['pt']) ? $_SESSION['pt'] : [];

                            // foreach ($allPT as $pt) {
                            //     if (in_array($pt, $userPT)) {
                            //         echo '<option value="' . $pt . '" ' . (($filterPT === $pt) ? 'selected' : '') . '>' . $pt . '</option>';
                            //     }
                            // }

                            foreach ($allPT as $pt) {
                                $selected = ($filterPT === $pt) ? 'selected' : '';
                    ...
                    <select name="approvedornot" id="" name="approvedornot" class="form-select" onchange="this.form.submit()">
                        <option value="">Semua</option>
                        <option value="">Sudah Approve</option>
                                ...
                                if ($resultAkses) {
                                    ...
                                    while ($row = $resultAkses->fetch_assoc()) {
                                        ...
                                        if ($isKerusakan) {
                                            ...
                                            // disiapkan untuk history_n_temp_ba_pengembalian
                                        ...
                                        if ($pendingDelete == 1){
                                            if ($isKerusakan) {
                                                ...
                                                echo "<td class='pt-3 custom-font fw-bold' style='color: #850404;'>Berita Acara Pengembalian Inventaris</td>";
                                            } elseif ($isNotebook) {
                                                echo "<td class='pt-3 custom-font fw-bold' style='color: #850404;'>Berita Acara Serah Terima Inventaris</td>";
                                            } elseif ($isMutasi) {
                                                echo "<td class='pt-3 custom-font fw-bold' style='color: #850404;'>Berita Acara Mutasi Aset Internal</td>";
                                            } elseif ($isSTAsset) {
                                            ...
                                            if ($pending) {
                                                if ($isKerusakan) {
                                                    ...
                                                    echo "<td class='pt-3 custom-font fw-bold' style='color: #856404;'>Berita Acara Pengembalian Inventaris</td>";
                                                } elseif ($isNotebook) {
                                                    echo "<td class='pt-3 custom-font fw-bold' style='color: #856404;'>Berita Acara Serah Terima Inventaris</td>";
                                                } elseif ($isMutasi) {
                                                    echo "<td class='pt-3 custom-font fw-bold' style='color: #856404;'>Berita Acara Mutasi Aset Internal</td>";
                                                } elseif ($isSTAsset) {
                                                ...
                                                if ($isKerusakan) {
                                                    ...
                                                    echo "<td class='custom-font pt-3'>Berita Acara Mutasi Aset Internal</td>";
                                                } elseif ($isSTAsset) {
                                        ...
                                        if ($isKerusakan) {
                                            ...
                                            $ptValue = isset($row['lokasi_penerima']) ? $row['lokasi_penerima'] : '-';
                                        } elseif ($isNotebook) {
                                            $ptValue = isset($row['pt']) ? $row['pt'] : '-';
                                        } elseif ($isMutasi) {
                                        ...
                                        if ($pending) {
                                            if ($isKerusakan) {
                                                ...
                                                // wadah untuk tombol/aksi pending BA Pengembalian (belum diisi)
                                            } elseif ($isNotebook) {
                                            ...
                                            if ($isKerusakan) {
                                                ...
                                                // $namaPembuat = trim($row['pembuat'] ?? '');
                                                // $namaDiketahui = trim($row['penyetujui'] ?? '');
                                                ...
                                                elseif($pt_untuk_urutan === 'PT.MSAL (SITE)'){
                                                    echo "<td class='custom-font pt-3'>-</td>";
                                                    
                                                    echo "<td class='custom-font pt-3'>"
                                                        . statusBadge($approval_3, $row, 'approval_3', 'autograph_3', $peminjam, 'peminjam', 'kerusakan', $autograph_3, 'PT.MSAL (SITE)') .
                                                        "<br><div class='custom-font m-0 p-0 mt-1'>{$labelAprvPeminjam}</div></td>";

                                                    if ($row['approval_3'] == "1") {
                                                        echo "<td class='custom-font pt-3'>"
                                                            . statusBadge($approval_4, $row, 'approval_4', 'autograph_4', $atasanPeminjam, 'atasan_peminjam', 'kerusakan', $autograph_4, 'PT.MSAL (SITE)') .
                                                            "<br><div class='custom-font m-0 p-0 mt-1'>{$labelAprvAtasanPeminjam}</div></td>";
                                                    ...
                                                    if ($atasanPeminjam == "-" || $row['approval_4'] == "1") {
                                                        echo "<td class='custom-font pt-3'>"
                                                            . statusBadge($approval_5, $row, 'approval_5', 'autograph_5', $namaDiketahui, 'diketahui', 'kerusakan', $autograph_5, 'PT.MSAL (SITE)') .
                                                            "<br><div class='custom-font m-0 p-0 mt-1'>{$labelAprvDiketahui}</div></td>";
                                                    ...
                                                    if ($namaDiketahui == "-" || $row['approval_5'] == "1") {
                                                        echo "<td class='custom-font pt-3'>"
                                                            . statusBadge($approval_2, $row, 'approval_2', 'autograph_2', $namaPenyetujui, 'penyetujui', 'kerusakan', $autograph_2, 'PT.MSAL (SITE)') .
                                                            "<br><div class='custom-font m-0 p-0 mt-1'>{$labelAprv2}</div></td>";
                                                    } elseif ($namaPenyetujui != "-") {
                                                        echo "<td class='custom-font pt-3'><i class='bi bi-hourglass text-warning fs-6'></i><br><div class='custom-font m-0 p-0 mt-1'>{$labelAprv2}</div></td>";
                                                    } else {
                                                    ...
                                                    if ($namaPenyetujui == "-" || $row['approval_2'] == "1") {
                                                        echo "<td class='custom-font pt-3'>"
                                                            . statusBadge($approval_1, $row, 'approval_1', 'autograph_1', $namaPembuat, 'pembuat', 'kerusakan', $autograph_1, 'PT.MSAL (SITE)') .
                                                            "<br><div class='custom-font m-0 p-0 mt-1'>{$labelAprv1}</div></td>";
                                                    } elseif ($namaPembuat != "-") {
                                                ...
                                                if ($pt_untuk_akses_ptasal == $ptPertama) {
                                                echo "<td class='custom-font pt-3'>"
                                                ...
                                                if ($row['approval_1'] == "1" && $pt_untuk_akses_ptasal == $ptPertama) {
                                                    echo "<td class='custom-font pt-3'>"
                                                ...
                                                if ($row['approval_2'] == "1" && $pt_untuk_akses_ptasal == $ptPertama) {
                                                    echo "<td class='custom-font pt-3'>"
                                                ...
                                                if ($row['approval_3'] == "1" && $pt_untuk_akses_pttujuan == $ptPertama) {
                                                    echo "<td class='custom-font pt-3'>"
                                                ...
                                                if ($row['approval_4'] == "1" && $pt_untuk_akses_pttujuan == $ptPertama) {
                                                    echo "<td class='custom-font pt-3'>"
                                                ...
                                                if ($row['approval_5'] == "1" && $pt_untuk_akses_pttujuan == $ptPertama) {
                                                    echo "<td class='custom-font pt-3'>"
                                                ...
                                                if ($row['approval_6'] == "1" && $ptPertama == 'PT.MSAL (HO)') {
                                                    echo "<td class='custom-font pt-3'>"
                                                ...
                                                if ($row['approval_7'] == "1" && $ptPertama == 'PT.MSAL (HO)') {
                                                    echo "<td class='custom-font pt-3'>"
                                                ...
                                                if ($row['approval_8'] == "1" && $ptPertama == 'PT.MSAL (HO)') {
                                                    echo "<td class='custom-font pt-3'>"
                                                ...
                                                if ($row['approval_9'] == "1" && $ptPertama == 'PT.MSAL (HO)') {
                                                    echo "<td class='custom-font pt-3'>"
                                                ...
                                                if ($row['approval_10'] == "1" && $ptPertama == 'PT.MSAL (HO)') {
                                                    echo "<td class='custom-font pt-3'>"
                                                ...
                                                if ($pt_untuk_akses_STA == $ptPertama) {
                                                echo "<td class='custom-font pt-3'>"
                                                ...
                                                if ($row['approval_1'] == "1" && $pt_untuk_akses_STA == $ptPertama) {
                                                    echo "<td class='custom-font pt-3'>"
                                                ...
                                                if ($row['approval_2'] == "1" && $pt_untuk_akses_STA == $ptPertama) {
                                                    echo "<td class='custom-font pt-3'>"
                                                ...
                                                if ($row['approval_3'] == "1" && $pt_untuk_akses_STA == $ptPertama) {
                                                    echo "<td class='custom-font pt-3'>"
                                                ...
                                                echo "<td class='custom-font pt-3'>"
                                                    . statusBadge($approval_1, $row, 'approval_1', 'autograph_1', $nama_pengembali, 'pengembali', 'pengembalian', $autograph_1) .
                                                    "<br><div>{$labelAprv1}</div></td>";
                                                echo "<td class='custom-font pt-3'>"
                                                    . statusBadge($approval_2, $row, 'approval_2', 'autograph_2', $nama_penerima, 'penerima', 'pengembalian', $autograph_2) .
                                                    "<br><div>{$labelAprv2}</div></td>";
                                                echo "<td class='custom-font pt-3'>"
                                                    . statusBadge($approval_3, $row, 'approval_3', 'autograph_3', $diketahui_name, 'diketahui', 'pengembalian', $autograph_3) .
                                                    "<br><div>{$labelAprv3}</div></td>";
                                                echo "<td class='pt-3'>";
                                                ...
                                                echo "<a class='custom-btn-action btn btn-secondary btn-sm' href='detail_barang_pengembalian.php?id={$ids}'><i class='bi bi-eye-fill'></i></a> ";
                                                echo "<a class='custom-btn-action btn btn-primary btn-sm' href='surat_output_pengembalian.php?id={$ids}' target='_blank'><i class='bi bi-file-earmark-text-fill'></i></a> ";
                                            } elseif ($isNotebook) {
                                            ...
                                            elseif ($isKerusakan) {
                                                ...
                                                if (!empty($tanggal)) {
                                                    $bulanNum = (int)date('n', strtotime($tanggal));
                                                    $tahun = date('Y', strtotime($tanggal));
                                                    // $bulanRomawi = $bulanRomawiArr[$bulanNum] ?? '';
                                                    $bulanRomawi = isset($bulanRomawiArr[$bulanNum]) ? $bulanRomawiArr[$bulanNum] : '';
                                                }
                                            ...
                                            if ($isKerusakan) {
                                                ...
                                                if ($_SESSION['hak_akses'] === 'Admin' && $row['pt'] == $ptPertama ):
                                                ...
                                                $aktorApproval = [
                                                    ['nama' => $namaPengirim,   'approval' => $approval_1],
                                                    ['nama' => $namaPengirim2, 'approval' => $approval_2],
                                                    ['nama' => $namaHRDGAPengirim, 'approval' => $approval_3],
                                                    ['nama' => $namaPenerima1,  'approval' => $approval_4],
                                                    ['nama' => $namaPenerima2,  'approval' => $approval_5],
                                                    ['nama' => $namaHRDGAPenerima,   'approval' => $approval_6],
                                                    ['nama' => $namaDiketahui, 'approval' => $approval_7],
                                                    ['nama' => $namaPemeriksa1, 'approval' => $approval_8],
                                                    ['nama' => $namaPemeriksa2,  'approval' => $approval_9],
                                                    ['nama' => $namaPenyetujui1,  'approval' => $approval_10],
                                                    ['nama' => $namaPenyetujui2,   'approval' => $approval_11]
                                                ];
    ...
    <script>
        ...
        //             // === Load gambar TTD ke canvas ===
        //             if (pictAutograph && pictAutograph.trim() !== "") {
        //                 const img = new Image();
        //                 img.src = "../" + pictAutograph; // path persis dari DB, misal "assets/autograph/…"
        //                 img.onload = function() {
        //                     const canvas = document.getElementById("signature");
        //                     const ctx = canvas.getContext("2d");

        //                     // Clear canvas sebelum load
        //                     ctx.clearRect(0, 0, canvas.width, canvas.height);

        //                     // Hitung scale agar sesuai canvas tanpa merusak rasio
        //                     const scale = Math.min(canvas.width / img.width, canvas.height / img.height);
        //                     const x = (canvas.width / 2) - (img.width / 2) * scale;
        //                     const y = (canvas.height / 2) - (img.height / 2) * scale;
        ...
        //                 };
        //                 img.onerror = function() {
        //                     console.error("Gagal load gambar: " + pictAutograph);
        //                 };
        //             } else {
        //                 signaturePad.clear(); // Jika tidak ada gambar, canvas tetap bersih
        //             }
        ...
        //             document.getElementById("periodeBAAutograph").innerText = romawi;
        //             document.getElementById("tahunBAAutograph").innerText = tahun;
        //             document.getElementById("pictBAAutograph").innerText = pictAutograph;
        ...
        //         alert("Silakan buat tanda tangan terlebih dahulu sebelum menyimpan!");
        //         return;
        //     }

        //     const data = {
        //         id: document.getElementById("inputIdBAAutograph").value,
        //         approvalCol: document.getElementById("inputApprovalBAAutograph").value,
        //         autographCol: document.getElementById("inputAutographBAAutograph").value,
        //         nama: document.getElementById("inputNamaBAAutograph").value,
        //         peran: document.getElementById("inputPeranBAAutograph").value,
        //         jenis: document.getElementById("inputJenisBAAutograph").value,
        //         nomor: document.getElementById("inputNomorBAAutograph").value,
        //         periode: document.getElementById("inputPeriodeBAAutograph").value,
        //         tahun: document.getElementById("inputTahunBAAutograph").value,
        //         signature: signaturePad.toDataURL("image/png")
        //     };

        //     const formData = new FormData();
        //     formData.append("id", data.id);
        //     formData.append("approvalCol", data.approvalCol);
        //     formData.append("autographCol", data.autographCol);
        ...
        //         const res = await fetch("proses_autograph.php", {
        //             method: "POST",
        //             body: formData
        //         });
