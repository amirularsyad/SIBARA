...
?>
  ...
  <ol class="rata-nomor">
    ...
    <table class="data-barang" style="line-height: 1;">
        ...
        <tr><td>Prosesor</td><td>: <?php echo $data['prosesor']; ?></td></tr>
        <tr><td>Hard Disk</td><td>: <?php echo $data['penyimpanan']; ?></td></tr>
        <tr><td>Monitor</td><td>: <?php echo $data['monitor']; ?></td></tr>
        <tr><td>Baterai</td><td>: <?php echo $data['baterai']; ?></td></tr>
        <tr><td>VGA Card</td><td>: <?php echo $data['vga']; ?></td></tr>
        <tr><td>RAM</span></td><td>: <?php echo $data['ram']; ?></td></tr>
        <tr><td>Tgl. Pembelian</td><td>: <?php echo date('d', strtotime($data['tanggal_pembelian'])) . ' ' . bulanIndo($data['tanggal_pembelian']) . ' ' . date('Y', strtotime($data['tanggal_pembelian'])); ?></td></tr>
    </table>
<!-- PAGE BREAK -->
...
<div class="page">
    ...
    <table style="width: 100%; text-align:start; margin-top: 20px;font-family: Arial, Helvetica, sans-serif;">
        ...
        <td style="padding-top: 35px;">
            <?php if ($data['approval_1'] == 1): ?>
                <img src="../<?php echo $data['autograph_1']; ?>" alt="Tanda Tangan 1" style="max-height: 100px; max-width: 120px; object-fit: contain;">
            <?php endif; ?>
        </td>
        <td style="padding-top: 35px;padding-left:15%;">
            <?php if ($data['approval_2'] == 1): ?>
                <img src="../<?php echo $data['autograph_2']; ?>" alt="Tanda Tangan 2" style="max-height: 100px; max-width: 120px; object-fit: contain;">
            <?php endif; ?>
        </td>
        </tr>
        <tr>
    ...
    <table style="width: 100%; text-align: start;font-family: Arial, Helvetica, sans-serif;">
        <tr style="height: 120px;">
            <td style="padding-top: 35px;">
                <?php if ($data['approval_3'] == 1): ?>
                    <img src="../<?php echo $data['autograph_3']; ?>" alt="Tanda Tangan 3" style="max-height: 100px; max-width: 120px; object-fit: contain;">
                <?php endif; ?>
            </td>
        </tr>
        <tr>
        ...
        <td style="padding-top:35px; padding-left:15px;">
            <?php if ($data['approval_4'] == 1): ?>
                <img src="../<?php echo $data['autograph_4']; ?>" alt="Tanda Tangan 4" style="max-height: 100px; max-width: 120px; object-fit: contain;">
            <?php endif; ?>
        </td>
        </tr>
        <tr>
